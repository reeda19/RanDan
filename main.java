...
public class main {
	...
	public static void addCenterCount(Card card) {
		...
		if (card.rank == 14) { // Fix this (Aces count as 1 now)
	...
	public static void CPUTurn() {
		...
		case 3:
			if (amountUntil40 <= 11 && cpu.findCard(amountUntil40) != -1) {
	...
	// Plays highest card in CPU hand
	public static void PlayHighest() {
		CPUGo(cpu.getLength() - 1);
	}
